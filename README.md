...
| 套餐 | 当前公开价格 | OpenAI 页面显示的主要功能差异 | 需要注意 |
| --- | ---: | --- | --- |
| Free | $0/月 | 可体验简短的编程任务 | 模型、功能和用量有限制 |
| **Go** | **$8/月** | 面向轻量级编程任务 | 用量和高级功能低于 Plus |
| **Plus** | **$20/月** | 支持 Web、CLI、IDE 扩展和 iOS；包含自动代码审查、Slack 集成及 GPT-5.6 Sol、Terra、Luna | 适合每周多次专注使用，具体额度会变化 |
| **Pro 5x** | **$100/月** | 包含 Plus 功能；可使用 GPT-5.3-Codex-Spark 研究预览；Codex 用量约为 Plus 的 5 倍 | 桌面语音约 1–2.5 小时/5 小时窗口 |
| **Pro 20x** | **$200/月** | 包含 Plus 功能；可使用 GPT-5.3-Codex-Spark 研究预览；Codex 用量约为 Plus 的 20 倍 | 桌面语音可无限使用，但语音发起的任务仍消耗 Codex 用量 |
| Business | $20/用户/月起 | 团队工作区、管理控制、SAML SSO、MFA，默认不使用业务数据训练模型 | 年付起价，至少 2 位用户；月付价格不同 |
| Enterprise / Edu | 联系销售 | 企业级安全、审计、身份与数据控制 | 价格、功能和额度按合同及工作区设置确定 |

### Go、Plus、Pro 5x 和 Pro 20x 怎么区分？
