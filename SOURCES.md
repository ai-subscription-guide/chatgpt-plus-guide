...
| 来源 | 可直接确认的内容 | 核对日期 |
| --- | --- | --- |
| [WildAI 首页](https://bewild.ai/?code=AIG) | 服务介绍、经营主体、Terms、Privacy、Affiliate 与 Contact 入口 | 2026-08-20 |
| [WildAI 订阅页](https://bewild.ai/subscribe) | 当前公开展示的产品入口和页面报价 | 2026-08-20 |
| [邀请码注册截图](assets/wildai-invite-aig-2026-08-20.png) | `?code=AIG` 会在注册窗口自动填入邀请码 AIG | 2026-08-20 |

## 事实边界

- 邀请码 `AIG` 的 1 美元优惠依据用户在注册页面看到的活动说明记录；活动可能调整，付款前必须以注册或结算页面实时显示为准。
